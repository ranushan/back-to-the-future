...
public class BackToTheFuture {
    ...
    private static void discount(
            int backToFuture,
            IntToDoubleFunction noDiscount,
            IntToDoubleFunction firstDiscount,
            IntToDoubleFunction secondDiscount
    ) {
        count += switch (backToFuture) {
            case 0 -> 0;
            case 1 -> noDiscount.applyAsDouble(backToFuture);
            case 2 -> firstDiscount.applyAsDouble(backToFuture);
            default -> secondDiscount.applyAsDouble(backToFuture);
        };
    }
